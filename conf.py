...
BLOG_AUTHOR = "Organización Scalibur"  # (translatable)
...
PAGES = (
    ("pages/*.rst", "corp", "page.tmpl"),
    ("pages/*.md", "corp", "page.tmpl"),
    #("pages/*.txt", "corp", "page.tmpl"),
    #("pages/*.html", "corp", "page.tmpl"),
)
...
# LOGO_URL = '/images/logo_scalibur.png'
...
AUTHOR_PAGES_DESCRIPTIONS = {
   DEFAULT_LANG: {
       "Edward Villegas-Pulgarin": "Vicepresidente.",
       "Juan Carlos Molina": "Presidente y fundador.",
       "Daniel Muñoz": "Tesorero.",
       "Paula Nevado": "Secretario."
   },
}
...
FRONT_INDEX_HEADER = {
    DEFAULT_LANG: 'Bienvenidos al blog oficial de la Organización Scalibur.'
}
...
<input type="submit" value="Buscar en scaliburco" style="visibility: hidden;">
</form>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-169406483-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-169406483-1');
</script>
...
TWITTER_CARD = {
    ...
    'site': '@scaliburco',         # twitter nick for the website
    'creator': '@scaliburco',     # Username for the content creator / author.
}
